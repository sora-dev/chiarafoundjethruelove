...
<body>
                                        ...
                                        <div class="form-check-wrapper">
                                            <div class="form-check form-check-inline">
                                                <input class="form-check-input required" type="radio"
                                                    name="Attend wedding" id="attend_wedding_yes" />
                                                <label for="attend_wedding_yes">Yes, I will attend.</label>
                                            </div>

                                            <div class="form-check form-check-inline">
                                                <input class="form-check-input required" type="radio"
                                                    name="Attend wedding" id="attend_wedding_no" />
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-sm-12">
                            ...
                            <a href="https://sora.cx">Sora</a> with
    ...
    function submitForm(oFormElement) {
        ...
        xhr.onload = function() {
            ...
            document.getElementById("quoteForm").innerHTML +=
                "<h5 style='background-color: #E7BF22; color: #fff; padding: 0.5rem; margin: 0.5rem 0;'>" + xhr
                .responseText + "</h3>";
        }
    ...
    $('#menuBTN').click(function() {
        if (!$(this).parent().hasClass('elementor-active')) {
            $(this).parent().addClass('elementor-active').attr('aria-expanded', true);
            ...
            $(this).parent().removeClass('elementor-active').attr('aria-expanded', false);
